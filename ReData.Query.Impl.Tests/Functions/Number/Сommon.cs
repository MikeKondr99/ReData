...
public abstract class Сommon(ISqlRunner runner) : ExprTests(runner)
{
     ...
     [InlineData("Floor(3.88, 5.)", 0)]
     [InlineData("Floor(1.1, 1.)", 1)]
     [InlineData("Floor(4.7, .5)", 4.5)]
     [InlineData("Floor(1.1, 1.0, 0.5)", 0.5)]
     [InlineData("Floor(-150., 50., 25.)", -175)]
     ...
     [InlineData("Round(4.7, 2.)", 4.0)]
     [InlineData("Round(5.3, 2.)", 6.0)]
     [InlineData("Round(4.7, .5)", 4.5)]
     [InlineData("Round(5.3, .5)", 5.5)]
     [InlineData("Round(2.5, 1.)", 3)]
     [InlineData("Round(2., 4.)", 4)]
     [InlineData("Round(3.88875, 0.001)", 3.8890000000000000001)]
     [InlineData("Round(1.1, 1., .5)",1.5)]
     [InlineData("Round(2.5, 1., 0.)", 3.0)] // не проходит
     [InlineData("Round(2., 4., 0.)", 4.0)] 
     [InlineData("Round(100., 1., 200.)", 100)]
     [InlineData("Round(-130., 50., 25.)", -125)]
