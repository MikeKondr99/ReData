...
public sealed class SqlServerLiteralBuilder : ILiteralBuilder
{
    ...
    public StringBuilder Boolean(StringBuilder res, RawBooleanLiteral literal) => res.Append(literal.Value ? "0 = 0" : "0 <> 0");
