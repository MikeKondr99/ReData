...
const EditResource: React.FC = () => {
  ...
  const resourceTypeDefined = resourceType as 'postgresql' | 'mysql' | 'mongodb';
  const resourceIndex = resourceId ? parseInt(resourceId, 10) : -1;

  const existingResource = resourceIndex >= 0 ? resources[resourceIndex] : undefined;
  ...
  const [formData, setFormData] = useState({
    ...
    dbUsername: '',
    dbPassword: '',
    type: resourceTypeDefined || 'postgresql',
  });
      ...
      <Container>
        ...
        <Flex align="center" justify="space-between">
          <Flex align="center" gap="sm">
            ...
            <Title order={2}>Edit {resourceTypeDefined}</Title>
          </Flex>
