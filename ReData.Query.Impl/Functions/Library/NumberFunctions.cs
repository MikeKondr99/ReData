...
public static class NumberFunctions
{
    ...
    // TODO: NotTested
    public static Ret<Bool> Even(Number input) => new()
    {
        [All] = $"({input} % 2) = 0)", 
    };
    ...
    // TODO: NotTested
    public static Ret<Bool> Odd(Number input) => new()
    {
        [All] = $"({input} % 2) = 1)", 
    };
    ...
    // TODO: NotTested
    public static Ret<Bool> Sign(Integer input) => new()
    {
        [All] = $"SIGN({input})", 
    };
    
    // TODO: NotTested
    public static Ret<Bool> Sign(Number input) => new()
    {
        [All] = $"SIGN({input})", 
    };
